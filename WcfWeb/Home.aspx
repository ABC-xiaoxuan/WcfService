...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#">欢迎来到我们的书店</a>
    ...
    <div class="container h-100">
        <div class="row justify-content-center align-items-center h-100">
            <asp:Button ID="btnSearchBooks" runat="server" Text="书籍查询" OnClick="btnSearchBooks_Click" CssClass="btn btn-primary btn-lg mb-3 mx-2" />
